						...
						<div className="content d-flex flex-column flex-column-fluid" id="kt_content">
							...
							<div className="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
								<div className="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
										...
										<div className="d-flex align-items-baseline mr-5">
											...
											<ul className="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
												<li className="breadcrumb-item">
													<a href="" className="text-muted">General</a>
												</li>
												<li className="breadcrumb-item">
													<a href="" className="text-muted">Empty Page</a>
												</li>
											</ul>
											{/* <!--end::Breadcrumb--> */}
										</div>
									...
									<div className="d-flex align-items-center">
										{/* <!--begin::Actions--> */}
										<a href="#" className="btn btn-light font-weight-bold btn-sm">Actions</a>
										{/* <!--end::Actions--> */}
										{/* <!--begin::Dropdown--> */}
...
<a href="#">https://github.com</a></div>
			...
			<ul className="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
				...
				<li className="nav-item mb-2" id="kt_demo_panel_toggle" data-toggle="tooltip" title="Check out more demos" data-placement="right">
					<a className="btn btn-sm btn-icon btn-bg-light btn-text-success btn-hover-success" href="#">
						<i className="flaticon2-drop"></i>
					</a>
				</li>
				{/* <!--end::Item--> */}
				...
				<li className="nav-item mb-2" data-toggle="tooltip" title="Layout Builder" data-placement="left">
					<a className="btn btn-sm btn-icon btn-bg-light btn-text-primary btn-hover-primary" href="https://keenthemes.com/metronic/preview/demo1/builder.html" target="_blank">
						<i className="flaticon2-gear"></i>
					</a>
				</li>
				{/* <!--end::Item--> */}
				...
				<li className="nav-item mb-2" data-toggle="tooltip" title="Documentation" data-placement="left">
					<a className="btn btn-sm btn-icon btn-bg-light btn-text-warning btn-hover-warning" href="https://keenthemes.com/metronic/?page=docs" target="_blank">
				...
				<li className="nav-item" id="kt_sticky_toolbar_chat_toggler" data-toggle="tooltip" title="Chat Example" data-placement="left">
					<a className="btn btn-sm btn-icon btn-bg-light btn-text-danger btn-hover-danger" href="#" data-toggle="modal" data-target="#kt_chat_modal">
					...
					<div className="offcanvas-wrapper mb-5 scroll-pull">
						...
						<div className="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
							...
							<div className="overlay-layer">
								<a href="https://keenthemes.com/metronic/preview/demo1/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank">Default</a>
								<a href="https://keenthemes.com/metronic/preview/demo1/rtl/index.html" className="btn btn-light btn-shadow" target="_blank">RTL Version</a>
							</div>
						</div>
						...
						<div className="overlay rounded-lg mb-8 offcanvas-demo">
							...
							<div className="overlay-layer">
								<a href="https://keenthemes.com/metronic/preview/demo2/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank">Default</a>
								<a href="https://keenthemes.com/metronic/preview/demo2/rtl/index.html" className="btn btn-light btn-shadow" target="_blank">RTL Version</a>
							</div>
						</div>
						...
						<div className="overlay rounded-lg mb-8 offcanvas-demo">
							...
							<div className="overlay-layer">
								<a href="https://keenthemes.com/metronic/preview/demo3/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank">Default</a>
								<a href="https://keenthemes.com/metronic/preview/demo3/rtl/index.html" className="btn btn-light btn-shadow" target="_blank">RTL Version</a>
							</div>
						</div>
						...
						<div className="overlay rounded-lg mb-8 offcanvas-demo">
							...
							<div className="overlay-layer">
								<a href="https://keenthemes.com/metronic/preview/demo4/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank">Default</a>
								<a href="https://keenthemes.com/metronic/preview/demo4/rtl/index.html" className="btn btn-light btn-shadow" target="_blank">RTL Version</a>
							</div>
						</div>
						...
						<div className="overlay rounded-lg mb-8 offcanvas-demo">
							...
							<div className="overlay-layer">
								<a href="https://keenthemes.com/metronic/preview/demo5/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank">Default</a>
								<a href="https://keenthemes.com/metronic/preview/demo5/rtl/index.html" className="btn btn-light btn-shadow" target="_blank">RTL Version</a>
							</div>
						</div>
						...
						<div className="overlay rounded-lg mb-8 offcanvas-demo">
							...
							<div className="overlay-layer">
								<a href="https://keenthemes.com/metronic/preview/demo6/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank">Default</a>
								<a href="https://keenthemes.com/metronic/preview/demo6/rtl/index.html" className="btn btn-light btn-shadow" target="_blank">RTL Version</a>
							</div>
						</div>
						...
						<div className="overlay rounded-lg mb-8 offcanvas-demo">
							...
							<div className="overlay-layer">
								<a href="https://keenthemes.com/metronic/preview/demo7/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank">Default</a>
								<a href="https://keenthemes.com/metronic/preview/demo7/rtl/index.html" className="btn btn-light btn-shadow" target="_blank">RTL Version</a>
							</div>
						</div>
						...
						<div className="overlay rounded-lg mb-8 offcanvas-demo">
							...
							<div className="overlay-layer">
								<a href="https://keenthemes.com/metronic/preview/demo8/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank">Default</a>
								<a href="https://keenthemes.com/metronic/preview/demo8/rtl/index.html" className="btn btn-light btn-shadow" target="_blank">RTL Version</a>
							</div>
						</div>
						...
						<div className="overlay rounded-lg mb-8 offcanvas-demo">
							...
							<div className="overlay-layer">
								<a href="https://keenthemes.com/metronic/preview/demo9/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank">Default</a>
								<a href="https://keenthemes.com/metronic/preview/demo9/rtl/index.html" className="btn btn-light btn-shadow" target="_blank">RTL Version</a>
							</div>
						</div>
						...
						<div className="overlay rounded-lg mb-8 offcanvas-demo">
							...
							<div className="overlay-layer">
								<a href="https://keenthemes.com/metronic/preview/demo10/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank">Default</a>
								<a href="https://keenthemes.com/metronic/preview/demo10/rtl/index.html" className="btn btn-light btn-shadow" target="_blank">RTL Version</a>
							</div>
						</div>
						...
						<div className="overlay rounded-lg mb-8 offcanvas-demo">
							...
							<div className="overlay-layer">
								<a href="#" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
							</div>
						</div>
