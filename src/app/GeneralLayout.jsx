    ...
    return (<>
			                  ...
			                  <div className="tab-content">
			                      ...
			                      <div className="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200">
			                        ...
			                        <div className="d-flex align-items-center mb-6">
			                          ...
			                          <div className="d-flex flex-column font-weight-bold">
			                            <a href="index.html" className="text-dark text-hover-primary mb-1 font-size-lg">Cool App</a>
			                        ...
			                        <div className="d-flex align-items-center mb-6">
			                          ...
			                          {/* <!--begin::Text--> */}
			                          <div className="d-flex flex-column font-weight-bold">
			                            <a href="index.html" className="text-dark-75 text-hover-primary mb-1 font-size-lg">Awesome SAAS</a>
			                        ...
			                        <div className="d-flex align-items-center mb-6">
			                          ...
			                          {/* <!--begin::Text--> */}
			                          <div className="d-flex flex-column font-weight-bold">
			                            <a href="index.html" className="text-dark text-hover-primary mb-1 font-size-lg">Claudy Sys</a>
			                        ...
			                        <div className="d-flex align-items-center mb-6">
			                          ...
			                          {/* <!--begin::Text--> */}
			                          <div className="d-flex flex-column font-weight-bold">
			                            <a href="index.html" className="text-dark text-hover-primary mb-1 font-size-lg">Trilo Service</a>
			                        ...
			                        <div className="d-flex align-items-center mb-6">
			                          ...
			                          {/* <!--begin::Text--> */}
			                          <div className="d-flex flex-column font-weight-bold">
			                            <a href="index.html" className="text-dark text-hover-primary mb-1 font-size-lg">Bravia SAAS</a>
			                        ...
			                        <div className="d-flex align-items-center mb-6">
			                          ...
			                          {/* <!--begin::Text--> */}
			                          <div className="d-flex flex-column font-weight-bold">
			                            <a href="index.html" className="text-dark text-hover-primary mb-1 font-size-lg">Express Wind</a>
			                        ...
			                        <div className="d-flex align-items-center mb-6">
			                          ...
			                          {/* <!--begin::Text--> */}
			                          <div className="d-flex flex-column font-weight-bold">
			                            <a href="index.html" className="text-dark text-hover-primary mb-1 font-size-lg">Bruk Fitness</a>
			                    ...
			                    <div className="tab-pane" id="topbar_notifications_events" role="tabpanel">
			                      ...
			                      <div className="navi navi-hover scroll my-4" data-scroll="true" data-height="300" data-mobile-height="200">
			                        {/* <!--begin::Item--> */}
			                        <a href="index.html" className="navi-item">
			            ...
			            <div className="dropdown">
			              ...
			              <div className="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
			                ...
			                <div className="row row-paddingless">
			                  {/* <!--begin:Item--> */}
			                  <div className="col-6">
			                    <a href="index.html" className="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
			                  ...
			                  {/* <!--begin:Item--> */}
			                  <div className="col-6">
			                    <a href="index.html" className="d-block py-10 px-5 text-center bg-hover-light border-bottom">
			                      <span className="svg-icon svg-icon-3x svg-icon-success">
			                  ...
			                  {/* <!--begin:Item--> */}
			                  <div className="col-6">
			                    <a href="index.html" className="d-block py-10 px-5 text-center bg-hover-light border-right">
			                      <span className="svg-icon svg-icon-3x svg-icon-success">
			                  ...
			                  {/* <!--begin:Item--> */}
			                  <div className="col-6">
			                    <a href="index.html" className="d-block py-10 px-5 text-center bg-hover-light">
			                      <span className="svg-icon svg-icon-3x svg-icon-success">
			          ...
			          <div className="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			            ...
			            <div className="d-flex align-items-center flex-wrap mr-1">
			              ...
			              <div className="d-flex align-items-baseline mr-5">
			                {/* <!--begin::Page Title--> */}
			                <h5 className="text-dark font-weight-bold my-2 mr-5">Empty Page</h5>
			                {/* <!--end::Page Title--> */}
			                {/* <!--begin::Breadcrumb--> */}
			                <ul className="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
			                  <li className="breadcrumb-item">
			                    <a href="index.html" className="text-muted">General</a>
			                  </li>
			                  <li className="breadcrumb-item">
			                    <a href="index.html" className="text-muted">Empty Page</a>
			                  </li>
			                </ul>
			                {/* <!--end::Breadcrumb--> */}
			              </div>
			            ...
			            <div className="d-flex align-items-center">
			              {/* <!--begin::Actions--> */}
			              <a href="index.html" className="btn btn-light font-weight-bold btn-sm">Actions</a>
			              {/* <!--end::Actions--> */}
			              {/* <!--begin::Dropdown--> */}
			              <div className="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
			                <a href="index.html" className="btn btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			                ...
			                <div className="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 m-0">
			                  ...
			                  <ul className="navi navi-hover">
			                    ...
			                    <li className="navi-footer py-4">
			                      <a className="btn btn-clean font-weight-bold btn-sm" href="index.html">
			...
			<div id="kt_quick_user" className="offcanvas offcanvas-right p-10">
			  ...
			  <div className="offcanvas-header d-flex align-items-center justify-content-between pb-5">
			    ...
			    <a href="index.html" className="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_user_close">
			  ...
			  <div className="offcanvas-content pr-5 mr-n5">
			    ...
			    <div className="d-flex align-items-center mt-5">
			      ...
			      <div className="d-flex flex-column">
			        <a href="index.html" className="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">James Jones</a>
			    ...
			    <div>
			      ...
			      <div className="d-flex align-items-center bg-light-warning rounded p-5 gutter-b">
			        ...
			        <div className="d-flex flex-column flex-grow-1 mr-2">
			          <a href="index.html" className="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">Another purpose persuade</a>
			      ...
			      <div className="d-flex align-items-center bg-light-success rounded p-5 gutter-b">
			        ...
			        <div className="d-flex flex-column flex-grow-1 mr-2">
			          <a href="index.html" className="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">Would be to people</a>
			          <span className="text-muted font-size-sm">Due in 2 Days</span>
			        </div>
			      ...
			      <div className="d-flex align-items-center bg-light-danger rounded p-5 gutter-b">
			        ...
			        <div className="d-flex flex-column flex-grow-1 mr-2">
			          <a href="index.html" className="font-weight-normel text-dark-75 text-hover-primary font-size-lg mb-1">Purpose would be to persuade</a>
			          <span className="text-muted font-size-sm">Due in 2 Days</span>
			        </div>
			      ...
			      <div className="d-flex align-items-center bg-light-info rounded p-5">
			        ...
			        <div className="d-flex flex-column flex-grow-1 mr-2">
			          <a href="index.html" className="font-weight-normel text-dark-75 text-hover-primary font-size-lg mb-1">The best product</a>
			          <span className="text-muted font-size-sm">Due in 2 Days</span>
			        </div>
			...
			<div id="kt_quick_cart" className="offcanvas offcanvas-right p-10">
			  ...
			  <div className="offcanvas-header d-flex align-items-center justify-content-between pb-7">
			    ...
			    <a href="index.html" className="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_cart_close">
			      <i className="ki ki-close icon-xs text-muted"></i>
			    </a>
			  </div>
			  {/* <!--end::Header--> */}
			    ...
			    <div className="offcanvas-wrapper mb-5 scroll-pull">
			      ...
			      <div className="d-flex align-items-center justify-content-between py-8">
			        <div className="d-flex flex-column mr-2">
			          <a href="index.html" className="font-weight-bold text-dark-75 font-size-lg text-hover-primary">iBlender</a>
			          ...
			          <div className="d-flex align-items-center mt-2">
			            ...
			            <a href="index.html" className="btn btn-xs btn-light-success btn-icon mr-2">
			              <i className="ki ki-minus icon-xs"></i>
			            </a>
			            <a href="index.html" className="btn btn-xs btn-light-success btn-icon">
			              <i className="ki ki-plus icon-xs"></i>
			            </a>
			          </div>
			        </div>
			        <a href="index.html" className="symbol symbol-70 flex-shrink-0">
			      ...
			      <div className="d-flex align-items-center justify-content-between py-8">
			        <div className="d-flex flex-column mr-2">
			          <a href="index.html" className="font-weight-bold text-dark-75 font-size-lg text-hover-primary">SmartCleaner</a>
			      ...
			      <div className="d-flex align-items-center justify-content-between py-8">
			        <div className="d-flex flex-column mr-2">
			          <a href="index.html" className="font-weight-bold text-dark-75 font-size-lg text-hover-primary">CameraMax</a>
			      ...
			      <div className="d-flex align-items-center justify-content-between py-8">
			        <div className="d-flex flex-column mr-2">
			          <a href="index.html" className="font-weight-bold text-dark text-hover-primary">4D Printer</a>
			      ...
			      <div className="d-flex align-items-center justify-content-between py-8">
			        <div className="d-flex flex-column mr-2">
			          <a href="index.html" className="font-weight-bold text-dark text-hover-primary">MotionWire</a>
			...
			<div id="kt_quick_panel" className="offcanvas offcanvas-right pt-5 pb-10">
			  ...
			  <div className="offcanvas-header offcanvas-header-navs d-flex align-items-center justify-content-between mb-5">
			    ...
			    <div className="offcanvas-close mt-n1 pr-5">
			      <a href="index.html" className="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_panel_close">
			        <i className="ki ki-close icon-xs text-muted"></i>
			      </a>
			    </div>
			  </div>
			      ...
			      <div className="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
			        ...
			        <div className="mb-15">
			          ...
			          <div className="d-flex align-items-center flex-wrap mb-5">
			            ...
			            <div className="d-flex flex-column flex-grow-1 mr-2">
			              <a href="index.html" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">Top Authors</a>
			          ...
			          <div className="d-flex align-items-center flex-wrap mb-5">
			            ...
			            <div className="d-flex flex-column flex-grow-1 mr-2">
			              <a href="index.html" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">Popular Authors</a>
			              <span className="text-muted font-weight-bold">Most Successful Fellas</span>
			            </div>
			          ...
			          <div className="d-flex align-items-center flex-wrap mb-5">
			            ...
			            <div className="d-flex flex-column flex-grow-1 mr-2">
			              <a href="index.html" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">New Users</a>
			              <span className="text-muted font-weight-bold">Most Successful Fellas</span>
			            </div>
			          ...
			          <div className="d-flex align-items-center flex-wrap mb-5">
			            ...
			            <div className="d-flex flex-column flex-grow-1 mr-2">
			              <a href="index.html" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">Active Customers</a>
			              <span className="text-muted font-weight-bold">Most Successful Fellas</span>
			            </div>
			            <span className="btn btn-sm btn-light font-weight-bolder my-lg-0 my-2 py-1 text-dark-50">+4500$</span>
			          </div>
			          ...
			          <div className="d-flex align-items-center flex-wrap">
			            ...
			            <div className="d-flex flex-column flex-grow-1 mr-2">
			              <a href="index.html" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">Bestseller Theme</a>
			              <span className="text-muted font-weight-bold">Most Successful Fellas</span>
			            </div>
			            <span className="btn btn-sm btn-light font-weight-bolder my-lg-0 my-2 py-1 text-dark-50">+4500$</span>
			          </div>
			    ...
			    <div className="modal-content">
			      ...
			      <div className="card card-custom">
			        ...
			        <div className="card-body">
			          {/* <!--begin::Scroll--> */}
			          <div className="scroll scroll-pull" data-height="400" data-mobile-height="350">
			            {/* <!--begin::Messages--> */}
			            <div className="messages">
			              ...
			              <div className="d-flex flex-column mb-5 align-items-start">
			                <div className="d-flex align-items-center">
			                  ...
			                  <div>
			                    <a href="index.html" className="text-dark-75 text-hover-primary font-weight-bold font-size-h6">Matt Pears</a>
			              ...
			              <div className="d-flex flex-column mb-5 align-items-end">
			                <div className="d-flex align-items-center">
			                  <div>
			                    ...
			                    <a href="index.html" className="text-dark-75 text-hover-primary font-weight-bold font-size-h6">You</a>
			                  </div>
			              ...
			              <div className="d-flex flex-column mb-5 align-items-start">
			                ...
			                <div className="mt-2 rounded p-5 bg-light-success text-dark-50 font-weight-bold font-size-lg text-left max-w-400px">You can unwatch this repository immediately by clicking here:
			                  <a href="index.html">https://github.com</a></div>
			              </div>
			              {/* <!--end::Message In--> */}
			              {/* <!--begin::Message Out--> */}
			              <div className="d-flex flex-column mb-5 align-items-end">
			        ...
			        <div className="card-footer align-items-center">
			          ...
			          <div className="d-flex align-items-center justify-content-between mt-5">
			            <div className="mr-3">
			              <a href="index.html" className="btn btn-clean btn-icon btn-md mr-1">
			                <i className="flaticon2-photograph icon-lg"></i>
			              </a>
			              <a href="index.html" className="btn btn-clean btn-icon btn-md">
			...
			<div id="kt_demo_panel" className="offcanvas offcanvas-right p-10">
			  ...
			  <div className="offcanvas-header d-flex align-items-center justify-content-between pb-7">
			    ...
			    <a href="index.html" className="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_demo_panel_close">
			      <i className="ki ki-close icon-xs text-muted"></i>
			    </a>
			  </div>
			  {/* <!--end::Header--> */}
			  ...
			  <div className="offcanvas-content">
			    ...
			    <div className="offcanvas-wrapper mb-5 scroll-pull">
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo1.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="https://keenthemes.com/metronic/preview/demo1/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank" rel="noreferrer">Default</a>
			          <a href="https://keenthemes.com/metronic/preview/demo1/rtl/index.html" className="btn btn-light btn-shadow" target="_blank" rel="noreferrer">RTL Version</a>
			        </div>
			      </div>
			      <h5 className="font-weight-bold mb-4 text-center">Demo 2</h5>
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo2.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="https://keenthemes.com/metronic/preview/demo2/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank" rel="noreferrer">Default</a>
			          <a href="https://keenthemes.com/metronic/preview/demo2/rtl/index.html" className="btn btn-light btn-shadow" target="_blank" rel="noreferrer">RTL Version</a>
			        </div>
			      </div>
			      <h5 className="font-weight-bold mb-4 text-center">Demo 3</h5>
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo3.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="https://keenthemes.com/metronic/preview/demo3/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank" rel="noreferrer">Default</a>
			          <a href="https://keenthemes.com/metronic/preview/demo3/rtl/index.html" className="btn btn-light btn-shadow" target="_blank" rel="noreferrer">RTL Version</a>
			        </div>
			      </div>
			      <h5 className="font-weight-bold mb-4 text-center">Demo 4</h5>
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo4.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="https://keenthemes.com/metronic/preview/demo4/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank" rel="noreferrer">Default</a>
			          <a href="https://keenthemes.com/metronic/preview/demo4/rtl/index.html" className="btn btn-light btn-shadow" target="_blank" rel="noreferrer">RTL Version</a>
			        </div>
			      </div>
			      <h5 className="font-weight-bold mb-4 text-center">Demo 5</h5>
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo5.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="https://keenthemes.com/metronic/preview/demo5/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank" rel="noreferrer">Default</a>
			          <a href="https://keenthemes.com/metronic/preview/demo5/rtl/index.html" className="btn btn-light btn-shadow" target="_blank" rel="noreferrer">RTL Version</a>
			        </div>
			      </div>
			      <h5 className="font-weight-bold mb-4 text-center">Demo 6</h5>
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo6.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="https://keenthemes.com/metronic/preview/demo6/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank" rel="noreferrer">Default</a>
			          <a href="https://keenthemes.com/metronic/preview/demo6/rtl/index.html" className="btn btn-light btn-shadow" target="_blank" rel="noreferrer">RTL Version</a>
			        </div>
			      </div>
			      <h5 className="font-weight-bold mb-4 text-center">Demo 7</h5>
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo7.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="https://keenthemes.com/metronic/preview/demo7/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank" rel="noreferrer">Default</a>
			          <a href="https://keenthemes.com/metronic/preview/demo7/rtl/index.html" className="btn btn-light btn-shadow" target="_blank" rel="noreferrer">RTL Version</a>
			        </div>
			      </div>
			      <h5 className="font-weight-bold mb-4 text-center">Demo 8</h5>
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo8.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="https://keenthemes.com/metronic/preview/demo8/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank" rel="noreferrer">Default</a>
			          <a href="https://keenthemes.com/metronic/preview/demo8/rtl/index.html" className="btn btn-light btn-shadow" target="_blank" rel="noreferrer">RTL Version</a>
			        </div>
			      </div>
			      <h5 className="font-weight-bold mb-4 text-center">Demo 9</h5>
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo9.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="https://keenthemes.com/metronic/preview/demo9/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank" rel="noreferrer">Default</a>
			          <a href="https://keenthemes.com/metronic/preview/demo9/rtl/index.html" className="btn btn-light btn-shadow" target="_blank" rel="noreferrer">RTL Version</a>
			        </div>
			      </div>
			      <h5 className="font-weight-bold mb-4 text-center">Demo 10</h5>
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo10.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="https://keenthemes.com/metronic/preview/demo10/index.html" className="btn font-weight-bold btn-primary btn-shadow" target="_blank" rel="noreferrer">Default</a>
			          <a href="https://keenthemes.com/metronic/preview/demo10/rtl/index.html" className="btn btn-light btn-shadow" target="_blank" rel="noreferrer">RTL Version</a>
			        </div>
			      </div>
			      <h5 className="font-weight-bold mb-4 text-center">Demo 11</h5>
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo11.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      </div>
			      <h5 className="font-weight-bold mb-4 text-center">Demo 12</h5>
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo12.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo13.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo14.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo15.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo16.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo17.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo18.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo19.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo20.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo21.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo22.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo23.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo24.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo25.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo26.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo27.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo28.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo29.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			      ...
			      <div className="overlay rounded-lg mb-8 offcanvas-demo">
			        <div className="overlay-wrapper rounded-lg">
			          <img src="assets//../../../../../../doc/assets/img/demos/demo30.png" alt="" className="w-100" />
			        </div>
			        <div className="overlay-layer">
			          <a href="index.html" className="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
			        </div>
			    ...
			    {/* <!--begin::Purchase--> */}
			    <div className="offcanvas-footer">
			      <a href="https://1.envato.market/EA4JP" target="_blank" rel="noreferrer" className="btn btn-block btn-danger btn-shadow font-weight-bolder text-uppercase">Buy Metronic Now!</a>
			    </div>
			    {/* <!--end::Purchase--> */}
			  </div>
			  {/* <!--end::Content--> */}
