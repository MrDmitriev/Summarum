...
import { DownloadCVButton, PageWraper, LeftMenu } from '../../components';
                        ...
                        <div className="kt-portlet__head-toolbar">
                            <ul className="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold" role="tablist">
                                <li className="nav-item">
                                    <a className="nav-link active" data-toggle="tab" href="davra.czkt_widget6_tab1_content" role="tab">
                                        Latest
                                    </a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" data-toggle="tab" href="davra.czkt_widget6_tab2_content" role="tab">
                                        Week
                                    </a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" data-toggle="tab" href="davra.czkt_widget6_tab3_content" role="tab">
                                        Month
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div className="tab-content">
                            <div className="tab-pane active" id="kt_widget6_tab1_content" aria-expanded="true">
                                <div className="kt-notification">
                                    <a href="davra.cz" className="kt-notification__item">
                                        <div className="kt-notification__item-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="kt-svg-icon kt-svg-icon--brand">
                                    ...
                                    <a href="davra.cz" className="kt-notification__item">
                                        ...
                                        <div className="kt-notification__item-details">
                                            <div className="kt-notification__item-title">
                                                Database sever davra.cz2 has been fully restarted.
                                            </div>
                                            <div className="kt-notification__item-time">
                                                23 hrs ago
                                            </div>
                            ...
                            <div className="tab-pane" id="kt_widget6_tab2_content" aria-expanded="false">
                                <div className="kt-notification">
                                    <a href="davra.cz" className="kt-notification__item">
                                        <div className="kt-notification__item-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="kt-svg-icon kt-svg-icon--success">
                                                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                                    <rect id="bound" x="0" y="0" width="24" height="24" />
                                    ...
                                    <a href="davra.cz" className="kt-notification__item">
                                        <div className="kt-notification__item-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="kt-svg-icon kt-svg-icon--danger">
                                                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                                    <rect id="bound" x="0" y="0" width="24" height="24" />
                                                    <path d="M5,3 L6,3 C6.55228475,3 7,3.44771525 7,4 L7,20 C7,20.5522847 6.55228475,21 6,21 L5,21 C4.44771525,21 4,20.5522847 4,20 L4,4 C4,3.44771525 4.44771525,3 5,3 Z M10,3 L11,3 C11.5522847,3 12,3.44771525 12,4 L12,20 C12,20.5522847 11.5522847,21 11,21 L10,21 C9.44771525,21 9,20.5522847 9,20 L9,4 C9,3.44771525 9.44771525,3 10,3 Z" id="Combined-Shape" fill="#000000" />
                                                    <rect id="Rectangle-Copy-2" fill="#000000" opacity="0.3" transform="translate(17.825568, 11.945519) rotate(-19.000000) translate(-17.825568, -11.945519) " x="16.3255682" y="2.94551858" width="3" height="18" rx="1" />
                                    ...
                                    <a href="davra.cz" className="kt-notification__item">
                                        <div className="kt-notification__item-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="kt-svg-icon kt-svg-icon--info">
                                                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                            ...
                            <div className="tab-pane" id="kt_widget6_tab3_content" aria-expanded="false">
                                <div className="kt-notification">
                                    <a href="davra.cz" className="kt-notification__item">
                                        <div className="kt-notification__item-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="kt-svg-icon kt-svg-icon--warning">
                                                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                                    <rect id="bound" x="0" y="0" width="24" height="24" />
