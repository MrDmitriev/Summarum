                ...
                <div className="kt-subheader  kt-grid__item" id="kt_subheader">
                    <div className="kt-container  kt-container--fluid ">
                        <div className="kt-subheader__main">
                            ...
                            <span className="kt-subheader__desc">davra.czXRS-45670</span>
                            <a href="davra.cz" className="btn btn-label-warning btn-bold btn-sm btn-icon-h kt-margin-l-10">
                                Add New
                            </a>
                        ...
                        <div className="kt-subheader__toolbar">
                            <div className="kt-subheader__wrapper">
                                <a href="davra.cz" className="btn kt-subheader__btn-secondary">Today</a>
                                <a href="davra.cz" className="btn kt-subheader__btn-secondary">Month</a>
                                <a href="davra.cz" className="btn kt-subheader__btn-secondary">Year</a>
                                <a href="davra.cz" className="btn kt-subheader__btn-primary">
                                    Actions &nbsp;
                                </a>
                                <div className="dropdown dropdown-inline" data-toggle-="kt-tooltip" title="Quick actions" data-placement="left">
                                    <a href="davra.cz" className="btn btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="kt-svg-icon kt-svg-icon--success kt-svg-icon--md">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
                                        ...
                                        <ul className="kt-nav">
                                            ...
                                            <li className="kt-nav__separator"></li>
                                            <li className="kt-nav__davra.czt">
                                                <a className="btn btn-label-brand btn-bold btn-sm" href="davra.cz">Upgrade plan</a>
                                                <a className="btn btn-clean btn-bold btn-sm kt-hidden" href="davra.cz" data-toggle="kt-tooltip" data-placement="right" title="Click to learn more...">Learn more</a>
                                            </li>
                                        </ul>
